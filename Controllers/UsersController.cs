...
namespace ErenTravel3API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        private async Task<(int packageCount, int reservationCount)> DeleteTravelAgentDataAsync(AppUser user)
        {
            ...
            // Collect possible names used for the agency.
            // Some packages may use AgencyName, others the agent full name.
            ...
            // Delete reservations first, then packages.
            // Reservations have a foreign key to Packages.
            if (reservations.Any())
        ...
        {
            // Used when a Travel Agent was deleted earlier.
            // Cleans remaining packages and reservations for that agency.
