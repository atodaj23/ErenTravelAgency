...
// Local XAMPP fallback and hosting variables.
...
using (var scope = app.Services.CreateScope())
{
    ...
    if (hasReservationTable > 0)
    {
        ...
        // Recreate incomplete old Reservations table.
    ...
    // Sync existing packages with frontend images.
    db.Database.ExecuteSqlRaw(@"
    ...
    // Default agent for Eren Travel packages.
    db.Database.ExecuteSqlRaw(@"
