...
namespace ErenTravel3API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        private async Task<(int packageCount, int reservationCount)> DeleteTravelAgentDataAsync(AppUser user)
        {
            ...
            // Marrim çdo emër të mundshëm që mund të jetë përdorur si agjenci.
            // Disa paketa mund të jenë ruajtur me AgencyName, disa me FullName të agentit.
            ...
            // Shumë e rëndësishme: fshijmë fillimisht rezervimet, pastaj paketat,
            // sepse Reservations kanë foreign key drejt Packages.
            if (reservations.Any())
        ...
        {
            // Përdoret për rastet kur një Travel Agent është fshirë më parë,
            // por kanë mbetur rezervime/paketa të agjencisë së tij.
