...
using (var scope = app.Services.CreateScope())
{
    ...
    if (hasReservationTable > 0)
    {
        ...
        // Versionet e vjetra kishin tabelë Reservations jo të plotë.
        // Nëse mungon PackageId, e rikrijojmë vetëm këtë tabelë që rezervimet të punojnë saktë.
    ...
    // Sinkronizim i paketave ekzistuese me fotot e frontend-it origjinal.
    // Kjo e bën që paketat e Eren Travel të shfaqen me foton përkatëse edhe nëse databaza ka ekzistuar nga versione të vjetra.
    db.Database.ExecuteSqlRaw(@"
    ...
    // Travel Agent i paracaktuar për agjencinë Eren Travel.
    // Mund të përdoret për të edituar ose fshirë paketat aktuale të publikuara nga Eren Travel.
    db.Database.ExecuteSqlRaw(@"
        INSERT INTO AppUsers (FullName, Email, Password, Role, AgencyName, TaxId, Address, Phone, IsApproved)
        SELECT 'Eren Travel Agent', 'erentravel@grupierenit.com', 'Eren123', 'TravelAgent', 'Eren Travel', 'EREN-TRAVEL-TAX', 'Tirana, Albania', '+355000000000', 1
